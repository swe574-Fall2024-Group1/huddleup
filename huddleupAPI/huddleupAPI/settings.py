"""
Django settings for huddleupAPI project.
...
ALLOWED_HOSTS=['http://100.24.63.191']
...
MIDDLEWARE = [
	...
	'authAPI.sessionMiddleware.SessionAuthenticationMiddleware'
]

SESSION_ENGINE = 'django.contrib.sessions.backends.db'

ROOT_URLCONF = 'huddleupAPI.urls'
...
WSGI_APPLICATION = 'huddleupAPI.wsgi.application'
